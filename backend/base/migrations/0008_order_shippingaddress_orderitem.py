# Generated by Django 4.2.4 on 2023-09-04 16:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('base', '0007_alter_restaurantmenu_quantity'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('dish', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.restaurantmenu')),
